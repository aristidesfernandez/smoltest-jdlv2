...
class CountryResourceIT {
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().code(DEFAULT_CODE).name(DEFAULT_NAME).identifier(DEFAULT_IDENTIFIER);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().code(UPDATED_CODE).name(UPDATED_NAME).identifier(UPDATED_IDENTIFIER);
        return country;
    }
    ...
    void putExistingCountry() throws Exception {
        ...
        updatedCountry.code(UPDATED_CODE).name(UPDATED_NAME).identifier(UPDATED_IDENTIFIER);
    ...
    void partialUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.code(UPDATED_CODE).name(UPDATED_NAME).identifier(UPDATED_IDENTIFIER);
